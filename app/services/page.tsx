          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {services.map((service, index) => (
              ...
              >
                ...
                <div className="bg-white/80 dark:bg-black/30 backdrop-blur-xl border border-black/[0.03] dark:border-white/5 shadow-[0_8px_30px_rgb(0,0,0,0.02)] p-8">
                  {/* Service Header */}
                  <div className="flex items-start justify-between mb-6">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <h3 className="font-serif text-2xl font-bold text-slate-800 dark:text-white">{service.title}</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {[
              ...
              >
                ...
                <h3 className="font-serif text-xl font-semibold text-slate-800 dark:text-white mb-3">{item.title}</h3>
